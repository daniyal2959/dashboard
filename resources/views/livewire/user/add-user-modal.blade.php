    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                @empty($name)
                    <h2 class="fw-bold">@lang('dashboard/user.add_user')</h2>
                @else
                    <h2 class="fw-bold">@lang('dashboard/user.update_user')</h2>
                @endempty
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="d-block fw-semibold fs-6 mb-5">@lang('dashboard/user.avatar')</label>
                            <!--end::Label-->
                            ...
                            <!--end::Image input-->
                            <!--begin::Hint-->
                            <div class="form-text">@lang('dashboard/user.allowed_file_types'): png, jpg, jpeg.</div>
                            <!--end::Hint-->
                            @error('avatar')
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">@lang('dashboard/user.name')</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">@lang('dashboard/user.email')</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-5">@lang('dashboard/user.role')</label>
                            <!--end::Label-->
                            @error('role')
                            <span class="text-danger">{{ $message }}</span> @enderror
                            <!--begin::Roles-->
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <label class="form-check-label" for="kt_modal_update_role_option_{{ $role->id }}">
                                            ...
                                            <div class="text-gray-600">
                                                @lang('dashboard/role.' . $role->name . '_description')
                                            </div>
                                        </label>
                                        <!--end::Label-->
                                    </div>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal" aria-label="Close" wire:loading.attr="disabled">@lang('dashboard/user.discard')</button>
                        <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
                            @empty($name)
                                <span class="indicator-label" wire:loading.remove>@lang('dashboard/user.submit')</span>
                            @else
                                <span class="indicator-label" wire:loading.remove>@lang('dashboard/user.update')</span>
                            @endempty
                            <span class="indicator-progress" wire:loading wire:target="submit">
                                @lang('dashboard/user.please_wait')
