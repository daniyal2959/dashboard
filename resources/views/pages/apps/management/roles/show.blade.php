                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <h2 class="mb-0">@lang('dashboard/role.' . $role->name)</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                        ...
                        <div class="d-flex flex-column text-gray-600">
                            @foreach($role->permissions->shuffle()->take(5) as $permission)
                                <div class="d-flex align-items-center py-2">
                                    ...
                                    {{ ucfirst(trans('dashboard/permission.' . $permission->name)) }}
                                </div>
                            @endforeach
                    ...
                    <div class="card-footer pt-0">
                        <button type="button" class="btn btn-light btn-active-primary" data-role-id="{{ $role->name }}" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">@lang('dashboard/role.edit_role')</button>
                    </div>
                    <!--end::Card footer-->
                </div>
                <!--end::Card-->
            ...
            <div class="flex-lg-row-fluid ms-lg-10">
                ...
                <div class="card card-flush mb-6 mb-xl-9">
                    ...
                    <div class="card-header pt-5">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2 class="d-flex align-items-center">@lang('dashboard/role.user_assigned')
