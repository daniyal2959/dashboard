...
<div class="app-navbar flex-shrink-0">
	...
	<div class="app-navbar-item ms-1 ms-md-4">
        ...
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
            ...
            @if( request()->input('notifications')->isNotEmpty() )
        ...
        @else
            @include('partials/menus/_notifications-empty')
        @endif
        <!--end::Menu wrapper-->
    </div>
    <!--end::Notifications-->
...
{{--    </div>--}}
{{--    <!--end::Chat-->--}}
{{--    <!--begin::Users with most ticket count-->--}}
{{--	<div class="app-navbar-item ms-1 ms-md-4">--}}
{{--        <!--begin::Menu wrapper-->--}}
...
{{--        <!--end::Menu wrapper-->--}}
{{--    </div>--}}
{{--    <!--end::Users with most ticket count-->--}}
    <!--begin::User menu-->
