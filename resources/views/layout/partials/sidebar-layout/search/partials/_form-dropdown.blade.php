...
<!--end::Icon-->
<!--begin::Input-->
<input type="text" class="search-input form-control form-control-flush ps-10" name="search" value="" placeholder="Search..." data-kt-search-element="input" wire:input.debounce.250ms="process($event.target.value)" />
<!--end::Input-->
<!--begin::Spinner-->
